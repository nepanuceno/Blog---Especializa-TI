...
<pagina tamanho="12">
    ...
    <painel titulo="PAINEL" tamanho="12" cor="bg-dark" fontcolor="text-dark">
        <div class="row">
            ...
            <caixa tamanho="3" icon="ion ion-bag" cor="bg-primary" valor="{{ $countArtigos }}" titulo="Artigos" fontcolor="text-white" textfooter="Mais Informações" link="{{ route('artigos.index')}}"></caixa>
            <caixa tamanho="3" icon="fa fa-users" cor="bg-success" valor="{{ $countUsuarios }}" titulo="Usuários" fontcolor="text-white" textfooter="Mais Informações" link="{{ route('usuarios.index')}}"></caixa>
            <caixa tamanho="3" icon="fa fa-user" cor="bg-warning" valor="{{ $countAutores }}" titulo="Autores" fontcolor="text-dark" textfooter="Mais Informações" link="{{ route('autores.index')}}"></caixa>
            <caixa tamanho="3" icon="fa fa-tags" cor="bg-info" valor="2" titulo="Categorias" fontcolor="text-white" textfooter="Mais Informações" link="#"></caixa>
