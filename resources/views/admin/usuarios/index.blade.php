...
<pagina tamanho="12">
    ...
    <modal nome="adicionar" titulo="Adicionar Usuario" footer="sim" cordafonte="text-white">
    ...
    <modal nome="editar" titulo="Editar Usuário" footer="sim" cordafonte="text-white">

        <formulario id="formSalvar" css="" v-bind:action="'/admin/usuarios/'+$store.state.itens.id" method="put" enctype="" token="{{ csrf_token() }}">
            <div class="form-group">
    ...
    <modal nome="deletar" titulo="Deletar Usuário" footer="sim" cor="bg-danger" cordafonte="text-white">
        <h3 class="text-white">
            Tem Certeza que deseja apagar permanentemente este Usuário?</h3>
        <span slot="botoes">
